 ...
 * |  \ |   |   A   |   S  |   D  |   F  |   G  |                              |  H   |   J  |    K    |    L    |   ;  :   |  ' "  |
 * |--------+-------+------+------+------+------+-------------.  ,-------------+------+------+---------+---------+----------+-------|
 * | F-keys |Shft/Z |Alt/X |Ctrl/C|Gui/V |   B  | Tab  | Home |  | End |  ] }  |  N   |Gui/M |Ctrl/ ,< | Alt/ .> | Shft/ /? |  - _  |
 * `--------+-------+------+------+------+------+------+------|  |------+------+------+------+---------+---------+----------+-------'
 ...
 */
    [_RAISE] = LAYOUT(
      ...
      _______, _______, _______, _______, _______, _______, _______, KC_CAPS,       _______, _______,KC_PAUSE, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_PSCR,
                                 _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______
    ),
